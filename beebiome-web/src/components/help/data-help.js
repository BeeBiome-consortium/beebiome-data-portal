            ...
            <div className={'row'}>
                <div className={'col-sm-10 offset-sm-1'}>
                    ...
                    <p>BeeBiome Data Portal contains metadata of datasets from NCBI having a host which is a species under the NCBI taxonomic level '<a
                        href={"https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id=34735"} target={"_blank"}
                        rel={"noopener noreferrer"}>Apoidea</a>'.
                    </p>
                    ...
                    <dl>
                        ...
                        <dd>Accession from <a href={"https://www.ncbi.nlm.nih.gov/bioproject"} target="_blank"
                                              rel={"noopener noreferrer"}>NCBI BioProject</a> (a collection of biological data related to a single initiative).</dd>

                        <dt>BioSample acc.</dt>
                        <dd>Accession from <a href={"https://www.ncbi.nlm.nih.gov/biosample"} target="_blank"
                                              rel={"noopener noreferrer"}>NCBI BioSample</a> (a database containing descriptions of biological source materials used in experimental assays).</dd>

                        <dt>SRA experiment entries</dt>
                        <dd>Count of entries from <a href={"https://www.ncbi.nlm.nih.gov/sra"} target="_blank"
                                                     rel={"noopener noreferrer"}>NCBI Sequence Read Archive (SRA)</a> (a repository of high throughput sequencing data).</dd>

                        <dt>NCBI Nucleotide entries</dt>
                        <dd>Count of entries from <a href={"https://www.ncbi.nlm.nih.gov/nucleotide"} target="_blank"
                                                     rel={"noopener noreferrer"}>NCBI Nucleotide</a> (a collection of genome, gene and transcript sequence data).</dd>
                        ...
                        <dd>Accession of a type of sample and specifies the list of attributes by which it should be described (<a
                            href={"https://www.ncbi.nlm.nih.gov/biosample/docs/packages/"} target="_blank"
                            rel={"noopener noreferrer"}>more details</a>).</dd>
                    </dl>
                </div>
            </div>);
    }
