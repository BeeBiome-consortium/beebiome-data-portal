 ...
 *       &lt;sequence>
 *         &lt;element name="Address" type="{SP.common}typeAddress" minOccurs="0"/>
 *         &lt;element name="Name" type="{SP.common}typeName" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="email" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="sec_email" type="{http://www.w3.org/2001/XMLSchema}string" />
...
@XmlType(name = "typeContactInfo", namespace = "SP.common", propOrder = {
    "address",
    "name"
})
public class TypeContactInfo {
    ...
    @XmlAttribute(name = "sec_email")
    protected String secEmail;
    ...
    /**
     * Obtient la valeur de la propriété secEmail.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété secEmail.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSecEmail(String value) {
        this.secEmail = value;
    }
